...
const Help = () => <div>
  ...
  <div className='help-body'>
    <ul>
      ...
      <li>Write transforms in the transform area in JavaScript (<HelpLink
        classes='link'
        anchor='request Python, Scala or something else'
        />)
      </li>
      <li><HelpLink
        classes='link'
      ...
      <li>Final output is of course also available as a JSON URL</li>
